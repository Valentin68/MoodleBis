	...
	if(empty($_SESSION['MBuser'])){
        ...
        // should return JSON with success as true
			...
			if(empty($valid_err_msgs)){
				...
				echo '<h2 class="success">Ton compte a bien été créé, il ne te reste plus qu\'à le valider grâce au lien contenu dans le mail que tu viens de recevoir sur ta messagerie UTBM !</h2>';	
			}
		}
		if(!$valid_data){
			?>
